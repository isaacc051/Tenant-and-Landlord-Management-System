...
INSTALLED_APPS = [
    ...
    # Local apps (placed before third-party apps to fix migration ordering)
    'accounts',
    'properties',
    'leases',
    'maintenance',
...
# Changed from 'mandatory' to 'none' to disable email verification
...
# Stripe settings (for payments) - Empty for development
STRIPE_PUBLIC_KEY = ''
STRIPE_SECRET_KEY = ''
STRIPE_WEBHOOK_SECRET = ''

# Add a comment to help users of your repository
"""
IMPORTANT SETUP NOTES:
1. Install required packages: pip install -r requirements.txt
2. For production deployment, configure proper email and payment settings
